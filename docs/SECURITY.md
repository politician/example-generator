...
Although we do our best to keep JS Example Generator secure. Vulnerabilities can happen. If you think you found a vulnerability, we appreciate your efforts to responsibly disclose your findings.

## Reporting a Vulnerability

Report security bugs by contacting us on romain-noreply@barissat.com (remove the -noreply). Report all other bugs on our GitHub issues page.
...
We take all security bugs seriously. Thank you for helping us improve the security of JS Example Generator, we will make every effort to acknowledge your contributions.
